module.exports = function( grunt ) {
	...
	if ( !grunt.option( "filename" ) ) {
		grunt.option( "filename", "dQuery.js" );
	}
	...
	grunt.initConfig( {
		...
		"compare_size": {
			files: [ "dist/dQuery.js", "dist/dQuery.min.js" ],
			options: {
				compress: {
		...
		uglify: {
			all: {
				...
				options: {
					...
					banner: "/*!dQuery is based on jQuery v<%= pkg.version %> " +
						" author:du, email:duwen32767@163.com | " +
