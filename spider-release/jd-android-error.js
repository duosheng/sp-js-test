...
!function () {
    ...
    DataSession.prototype = {
        ...
        openWithSpecifiedCore: function openWithSpecifiedCore(url, core) {
        ...
        setProgressMsg: function setProgressMsg(str) {
            if (!str) return;
...
//# sourceMappingURL=sources_maps/jd-android-error.js.map
