...
dSpider("taobao", 60 * 10, function (session, env, $) {
    ...
    if ($("div.submit>button").text().indexOf("登 录") != -1) {
        ...
        waitDomAvailable(".am-button", function (dom, timeSpan) {
    ...
    if (state == 0) {
        ...
        (function () {
            ...
            var intoOrderDetail = function intoOrderDetail() {
                log("--------------------------intoOrderDetail----------------------------");
            ...
            if (window.location.pathname.indexOf("mlapp/olist") != -1) {
                op = session.get("OrderItemPosition");
            ...
            if (window.location.pathname.indexOf("mymovie/pages") != -1) {
                ...
                if (oa == undefined) {
                    ...
                    currentOrderData = oa;
                    //拿到position后开始爬取
                    oip = session.get("OrderItemPosition");
            ...
            if (window.location.pathname.indexOf("bx/orderdetail.html") != -1) {
                log("--------------------------爬取保险----------------------------");
                tmpeOay = session.get("orderArray");
                ...
                if (tmpeOay == undefined) {
                    ...
                    (function () {
                        var getBxOrderDetail = function getBxOrderDetail() {
                        ...
                        tempOipn = session.get("OrderItemPosition");
                        bxtbOrderDetailInfo = {};
            ...
            if (window.location.pathname.indexOf("trip/flight") != -1) {
                ...
                if (tmpeOay == undefined) {
                    ...
                    (function () {
                        var getFJPOrderDetail = function getFJPOrderDetail() {
                ...
                (function () {
                    var getOrderDetail = function getOrderDetail() {
                        ...
                        for (var i = 0; i < ol.length; i++) {
                            ...
                            //商品名称
                            if (ol[i].className.indexOf("item") != -1) {
                                //---所有商品的item
                                ...
                                for (var k = 0; k < productInfo.length; k++) {
                                    ...
                                    if (productInfo[k].className.indexOf("item-list") != -1) {
                                        for (var m = 0; m < productInfo[k].children.length; m++) {
                                            if (productInfo[k].children[m].className.indexOf("item-info") != -1) {
                                                //----item中产品信息
                                            ...
                                            if (productInfo[k].children[m].className.indexOf("item-pay") != -1) {
                                                //----item中产品价格和数量
                    ...
                    var closeOrderDetail = function closeOrderDetail() {
                    ...
                    if (oay == undefined) {
                        ...
                        oipn = session.get("OrderItemPosition");
                        //拿到position后开始爬取
    ...
    //------------------------------------------------------------------------------------爬取收货地址----------------------------------------------------------------------------
        ...
        //------------------------------------------------------------------------------------爬取个人资料----------------------------------------------------------------------------
                 ...
                 * 爬取个人信息
                 */
                if (window.location.pathname.indexOf("baseInfoSet") != -1) {
                    //个人资料设置
                    var tempPersonInfo = {};
                ...
                if (window.location.pathname.indexOf("account_security") != -1) {
                    //个人资料设置
                    var perInfo = session.get("persionInfo");
                    if (perInfo == undefined) perInfo = {};
                    //电话号码
                    var phone;
                    var username;
                ...
                if (window.location.pathname.indexOf("certify_info") != -1) {
                    //身份认证界面
                    var perInfo = session.get("persionInfo");
                    if (perInfo == undefined) perInfo = {};
