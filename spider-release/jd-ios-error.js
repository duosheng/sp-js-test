...
!function () {
    ...
    function _logstr(str) {
        str = str || " ";
        return (typeof str === "undefined" ? "undefined" : _typeof(str)) == "object" ? JSON.stringify(str) : new String(str).toString();
    }
    function log(str) {
    ...
    function apiInit() {
        dQuery.noConflict();
        var withCheck = function withCheck(attr) {
    ...
    function dSpider(sessionKey, timeOut, callback) {
        if (window.onSpiderInited && this != 5) return;
        var $ = dQuery;
        var t = setInterval(function () {
            ...
            session._init(function () {
                ...
                DataSession.getExtraData(function (extras) {
                    $(safeCallback(function () {
                        ...
                        log("dSpider start!");
                        extras.config = (typeof _config === "undefined" ? "undefined" : _typeof(_config)) === "object" ? _config : "{}";
    ...
    DataSession.prototype = {
        ...
        showProgress: function showProgress(isShow) {
            log("showProgress called");
            callHandler("showProgress", { "show": isShow === undefined ? true : !!isShow });
        },
        setProgressMax: function setProgressMax(max) {
        ...
        getProgress: function getProgress(f) {},
        showLoading: function showLoading(s) {},
        hideLoading: function hideLoading() {},
        setStartUrl: function setStartUrl() {
            this.set('__loginUrl', location.href);
        },
        finish: function finish(errmsg, content, code, stack) {
            var that = this;
        ...
        upload: function upload(value, f) {
        ...
        load: function load(url, headers) {
            headers = headers || {};
        ...
        openWithSpecifiedCore: function openWithSpecifiedCore() {},

        autoLoadImg: function autoLoadImg(load) {
        ...
        setProgressMsg: function setProgressMsg() {
            if (!str) return;
...
//# sourceMappingURL=sources_maps/jd-ios-error.js.map
